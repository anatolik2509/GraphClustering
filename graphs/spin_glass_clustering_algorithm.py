...
class SpinGlassClusteringAlgorithm(ClusteringAlgorithm):
    ...
    def clustering(self, topology, node_weights):
        ...
        res = ig.community_spinglass(weights=edge_weights, spins=len(node_weights))
...
if __name__ == '__main__':
    ...
    alg = SpinGlassClusteringAlgorithm()
